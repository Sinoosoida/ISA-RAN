...
test_transforms = A.Compose([
    A.PadIfNeeded(min_height=None, min_width=None, pad_height_divisor=2**5, pad_width_divisor=2**5, border_mode=0, value=0, mask_value=0, always_apply=True),
    ToTensorV2(),
])
...
for filename in os.listdir(image_dir):
    if filename.lower().endswith(('.png', '.jpg', '.jpeg', '.tiff', '.tif')):
        ...
        processed_image = load_and_preprocess_image(image_path, image_processing, T=test_transforms, T_x=x_transforms).unsqueeze(0).unsqueeze(0)
